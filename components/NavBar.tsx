        ...
        <MainHolder>
            <Holder>
                ...
                <Link href='/create?s=0'>
                    <a>
                        <StyledSVG width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M24.4688 16.875H19.125V11.5312C19.125 11.3766 18.9984 11.25 18.8438 11.25H17.1562C17.0016 11.25 16.875 11.3766 16.875 11.5312V16.875H11.5312C11.3766 16.875 11.25 17.0016 11.25 17.1562V18.8438C11.25 18.9984 11.3766 19.125 11.5312 19.125H16.875V24.4688C16.875 24.6234 17.0016 24.75 17.1562 24.75H18.8438C18.9984 24.75 19.125 24.6234 19.125 24.4688V19.125H24.4688C24.6234 19.125 24.75 18.9984 24.75 18.8438V17.1562C24.75 17.0016 24.6234 16.875 24.4688 16.875Z" fill={stage == 2 ? '#29335C' : '#69708D'} />
                            <path d="M18 2.25C9.30234 2.25 2.25 9.30234 2.25 18C2.25 26.6977 9.30234 33.75 18 33.75C26.6977 33.75 33.75 26.6977 33.75 18C33.75 9.30234 26.6977 2.25 18 2.25ZM18 31.0781C10.7789 31.0781 4.92188 25.2211 4.92188 18C4.92188 10.7789 10.7789 4.92188 18 4.92188C25.2211 4.92188 31.0781 10.7789 31.0781 18C31.0781 25.2211 25.2211 31.0781 18 31.0781Z" fill={stage == 2 ? '#29335C' : '#69708D'} />
                        </StyledSVG>
                    </a>
                </Link>
                ...
                <Link href='/chat'>
                    <a>
                        <StyledSVG width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M30 3H6C4.35 3 3 4.35 3 6V33L9 27H30C31.65 27 33 25.65 33 24V6C33 4.35 31.65 3 30 3ZM30 24H9L6 27V6H30V24Z" fill={stage == 4 ? '#29335C' : '#69708D'} />
                        </StyledSVG>
                    </a>
                </Link>
            </Holder>
