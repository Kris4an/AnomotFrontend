...
`;
enum Reasons {
    NSFW_CONTENT = "NSFW_CONTENT", ADVERTISING = "ADVERTISING", VIOLENCE = "VIOLENCE", HARASSMENT = "HARASSMENT", HATE_SPEECH = "HATE_SPEECH", TERRORISM = "TERRORISM", SPAM = "SPAM"
}
interface Props {
    post: EPost,
