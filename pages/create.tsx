...
const CreateTitle = styled.input`
    ...
    font-family: 'Roboto';
    border-right: none;
    border-top: none;//1px solid ${props => props.theme.colors.secondary};
...
`;
const UploadPictureIcon = styled.svg`
    scale: 200%;
`;
...
function Content(){
    ...
    switch (stage) {
        case 1: {
            ...
            return (
                <>
                    {overlay ? <OverlayWindow stage={overlayStage} close={() => {setOverlay(false);}}/> : null}
                    <SelectionButtonMainHolder>
                        <SelectionButtonHolder>
                            <SelectionButton onClick={() => {updateUrlOverlay(0)}} isFirst={true} onMouseOver={() => { setSelButton(1) }} onMouseLeave={() => { setSelButton(0) }}>
                                <SelButtonSvg width="160" height="160" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <SelectionButton onClick={() => {}} isFirst={false} onMouseOver={() => { setSelButton(2) }} onMouseLeave={() => { setSelButton(0) }}>
                                <SelButtonSvg width="160" height="160" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <SelectionButton onClick={() => {updateUrlOverlay(1)}} isFirst={false} onMouseOver={() => { setSelButton(3) }} onMouseLeave={() => { setSelButton(0) }}>
                                <SelButtonSvg xmlns="http://www.w3.org/2000/svg" height="160" width="160" viewBox="0 0 48 48">
            ...
            return (
                <CreateBattleMainHolder>
                    <CreateBattleHolder>
                        ...
                        <TitleContentHolder>
                            <CreateTitle placeholder="Напиши заглавие..."></CreateTitle>
                            {
                                selectedPostType ?
                                    <UploadImageHolder>
                                        <UploadFileButton>
                                            <UploadPictureIcon xmlns="http://www.w3.org/2000/svg" height="48" width="48">
                                            ...
                                            <UploadFileButtonText>Качи снимка</UploadFileButtonText>
                                        </UploadFileButton>
                                    </UploadImageHolder>
                                    :
                                    <UploadImageHolder><Tiptap /></UploadImageHolder>
                            }
                        </TitleContentHolder>
                        <Button buttonType={"Solid"} handleClick={() => { setStage(1); router.push('/create?s=1');}} text={t1("continue")} style={{ width: '38rem' }}></Button>
                    </CreateBattleHolder>
                </CreateBattleMainHolder>
            )
        }
...
function OverlayWindow({close, stage}: OverlayProps){
    const [t1] = useTranslation("common");
    const [t2] = useTranslation("create-post");
            ...
            <OverlayHolder onClick={close}>
                <AuthContainer onClick={(e: any) => {
                    ...
                    <SliderHolder>
                        ...
                        <Slider type="range" min="100" max="1000" defaultValue={500} step="50" onChange={(e: any) => {setSliderValue(e.target.value)}}></Slider>
