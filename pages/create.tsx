                        ...
                        <TitleContentHolder>
                            
                            {
                                selectedPostType ?
                                    ...
                                    :
                                    <UploadImageHolder><Tiptap getText={(txt:string) => {setText(txt);}}/></UploadImageHolder>
                            }
                        </TitleContentHolder>
                        ...
                        handleClick={() => {
                            switch(selectedPostType){
                                case true: {
                                    ...
                                    switch(postType){
                                        case "post": {
                                            uploadFileFetcher('/account/post/media', formData);
                                            return;
                                        }
                                        case "battle": {
                                            uploadFileFetcher('/account/battle/media', formData);
                                            return;
                                        }
                                        case "geopost": {
                                            return;
                                ...
                                case false: {
                                    switch(postType){
                                        case "post": {
                                            uploadTextFetcher('/account/post/text', text);
                                            return;
                                        }
                                        case "battle": {
                                            uploadTextFetcher('/account/battle/text', text);
                                            return;
                                        }
                                        case "geopost": {
                                            return;
