...
const StyledPath = styled.path`
    transition: stroke ease-in-out 300ms, fill ease-in-out 300ms;
`;
...
const Account:NextPage = () => {
    ...
    return(
        <NavBar stage={3}>
            <MainHolder>
                <UpperHolder>
                    <ProfilePic type={true} handleClickProfile={() => {router.push('/settings?1')}}></ProfilePic>
                    <IconButtonHolder>
                        <IconButton icon={'Settings'} handleClick={() => { router.push('/settings') }} ></IconButton>
